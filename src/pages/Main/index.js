    ...
    <Container style={{ maxWidth: 680, minHeight: "100vh", paddingTop:'30px' }}>
      <Box sx={{ marginBottom: "2rem" }}>
        <Grid container alignItems="center" flexDirection="column">
          ...
          <Box className={classes.wrapName}>
            <h1 className={classes.name}><b>DƯƠNG VĂN HÙNG</b></h1>
          </Box>
          <Box className={classes.desc}>
            <h5 style={{ margin: 0 }}>KĨ SƯ XÂY DỰNG</h5>
          </Box>
        </Grid>
      </Box>
      <Box>
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="https://zalo.me/84982580757">Zalo</Link>
            </Grid>
          </CardContent>
        </Card>
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="https://www.facebook.com/profile.php?id=100008101564042">Facebook</Link>
            </Grid>
          </CardContent>
        </Card>
        {/* <Card className={classes.card}>
        ...
        <Card className={classes.card}>
          <CardContent className={classes.card_content}>
            <Grid container alignItems="center">
              ...
              <Link className={classes.link_content} target="_blank" href="tel:+84982580757">Phone number</Link>
            </Grid>
          </CardContent>
        </Card>
      </Box>
      <Box sx={{ marginTop: "4rem" }}>
        <Grid container alignItems="center" flexDirection="column">
          ...
          <Box className={classes.desc}>
            <h2 style={{ font: "inherit", margin: 0 }}>Tên Chủ Thẻ : Dương Văn Hùng</h2>
          </Box>
          <Box className={classes.desc}>
            <h2 style={{ font: "inherit", margin: 0 }}>Số Tài Khoản : 8030106013007</h2>
          </Box>
        </Grid>
      </Box>
